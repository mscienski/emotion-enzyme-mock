...
function styledParser(tag, styles, ...templateEntries) {
    ...
    if (typeof tag === 'string') {
        return (props) => {
            ...
            return React.createElement(tag, { className: finalClasses }, _get(props, 'children')); // eslint-disable-line react/prop-types
        };
        ...
        return (props) => {
            ...
            return React.createElement(name, { className: finalClasses }, _get(props, 'children')); // eslint-disable-line react/prop-types
        };
    }
